...
func LoadConfig() (Config, error) {
	...
	cfg := Config{
		...
		MQTTBrokerURL:           envString("MQTT_BROKER_URL", "wss://mqtt1.meshcore.au:443/mqtt"),
		MQTTTopic:               envString("MQTT_TOPIC", "meshcore/#"),
		MQTTClientID:            envString("MQTT_CLIENT_ID", "meshcore-australia-live-map-local"),
		...
		MQTTTokenAudience:       envString("MQTT_TOKEN_AUDIENCE", "mqtt1.meshcore.au"),
